          ...
          <div className="row g-4 justify-content-center">
            <div className="col-lg-12">
              <div className="hero-content">
                ...
                <div className="hero-button aos-init aos-animate" data-aos="fade-up" data-aos-duration="600" >
      ...
      <div className="brand-section fix section-padding">
        <div className="container">
          <div className="brand-wrapper">
            <h6 className="aos-init aos-animate" data-aos="fade-up" data-aos-duration="600" >
      ...
      <section className="project-section fix section-padding footer-bg">
        <div className="container">
          <div className="section-title text-center">
            <span className="sub-content text-white theme-bg-2 aos-init aos-animate" data-aos="fade-up" data-aos-duration="600">
              <img src="assets/img/bale.png" alt="img" />
              Popular Projects
            </span>
            <h2 className="text-white aos-init aos-animate" data-aos="fade-up" data-aos-duration="600" data-wow-delay="/3s">
            ...
            <div className="row g-4 justify-content-between align-items-center">
              <div className="col-xl-5 col-lg-6">
                <div className="planning-content">
                  ...
                  <div
                    className="planning-items mb-2aos-init aos-animate" data-aos="fade-up" data-aos-duration="600"
                  >
                  ...
                  <div
                    className="planning-items mt-0 mb-2 activeaos-init aos-animate" data-aos="fade-up" data-aos-duration="600"
                  >
                  ...
                  <div
                    className="planning-items mt-0aos-init aos-animate" data-aos="fade-up" data-aos-duration="600"
                  >
            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-7">
                <div className="cta-newsletter-content">
                  ...
                  <p className="text-white aos-init aos-animate" data-aos="fade-up" data-aos-duration="600" >
                    Sed ut perspiciatis unde omnis iste natus voluptatem
                    accusantiue <br />
